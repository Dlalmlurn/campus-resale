...
public class OrderController {
    ...
    @RequireLogin
    @GetMapping("/{id}/completion-requests")
    public CompletionRequestResponse getPendingCompletion(@PathVariable long id, HttpServletRequest servletRequest) {
        return orderService.getPendingCompletion(id, principal(servletRequest));
    }
